...
void clonar_tablero(int tablero[lado_tablero][lado_tablero], int clon[lado_tablero][lado_tablero]);

bool son_tableros_diferentes(int tablero[lado_tablero][lado_tablero], int clon[lado_tablero][lado_tablero]);
